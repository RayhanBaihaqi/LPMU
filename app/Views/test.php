		...
		<form action="<?= base_url('rkat/store'); ?>" method="POST" enctype="multipart/form-data">
			<div class="container">
				...
				<div class="form-group">
					...
					<select class="form-control" id="tahun_akademik" name="tahun_akademik" disabled>
				...
				<div class="form-group">
					...
					<input required type="text" name="pagu" class="form-control" id="pagu" name='pagu'
						placeholder="Masukkan Nama Prodi/Unit" value="<?= $set_rkat['pagu']; ?>" disabled>
				</div>
