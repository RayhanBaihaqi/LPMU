...
<head>
    ...
    <meta charset="utf-8">
    <title>Detail Pengabdian Masyarakat</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
            <h1>Detail Pengabdian Masyarakat</h1>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <h2 style="color: white;">Tabel Pengabdian Masyarakat</h2>
                                </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php foreach ($detail_pengmas as $row) : ?>
                                    <tr>
                                        <td><?= $row['id'] ?></td>
                                        <td><?= $row['kriteria'] ?></td>
                                        <td><?= $row['standar'] ?></td>
