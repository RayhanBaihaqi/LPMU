...
<head>
    ...
    <meta charset="utf-8">
    <title>Detail Pengembangan Program</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container-fluid">
            <h1>Detail Pengembangan Program</h1>
                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <h2 style="color: white;">Tabel Pengembangan Program</h2>
                                </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($detail_pengembanganprog as $row) : ?>
                                    <tr>
                                        <td scope="row"><?= $i++; ?></td>
