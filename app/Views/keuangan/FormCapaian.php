			...
			<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
				...
				<div class="collapse navbar-collapse justify-content-between">
					<div class="navbar-nav mr-auto">
						...
						<a href="<?= base_url('/CapaianRkat/createcapaianbykeuangan') ?>" class="nav-item nav-link active">Realisasi Anggaran</a>
					...
					<div class="">
						<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
							...
							<tfoot>
								...
								<td>
									<p>Persentase Serap: <input type="text" class="form-control form-control-sm " id="persenSerapGanjil" placeholder="0%" name="persenSerapGanjil" disabled></p>
								</td>
								<td><span id="totalanggarangenap"></span></td>
								<td><span id="tampilTotalGenap"></span></td>
								<td>
									<p>Persentase Serap: <input type="text" class="form-control form-control-sm" name="persenSerapGenap" id="persenSerapGenap" /></p>
								</td>
