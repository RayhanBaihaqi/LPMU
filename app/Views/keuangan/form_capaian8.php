    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-inline" id="kriteriaDiv">
                    ...
                    <form method="POST" action="">
                        <select class="form-control mb-2 mr-sm-2" id="kriteria" name="kriteria" onChange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            <option value="<?php echo site_url(); ?>keuangan/inputcapaian/8" disabled selected>8 - Pengabdian kepada Masyarakat (PkM)</option>
                ...
                <form id="formA" name="formA" action="<?= base_url('keuangan/savecapaian8'); ?>" method="POST" enctype="multipart/form-data">
