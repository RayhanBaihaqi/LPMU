			...
			<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
				...
				<div class="collapse navbar-collapse justify-content-between">
					<div class="navbar-nav mr-auto">
                        ...
                        <a href="<?= base_url('/lpmu/indexbyuser') ?>" class="nav-item nav-link active">Kesimpulan</a>
		...
		<div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('/lpmu/listrkat') ?>" class="btn btn-primary btn-block">Rincian Kesimpulan RKAT</a>
                    <a href="<?= base_url('lpmu/rincian') ?>" class="btn btn-primary btn-block">Rincian Persentase Capaian</a>
                	</div>
                </div>
            </div>
		</div>
