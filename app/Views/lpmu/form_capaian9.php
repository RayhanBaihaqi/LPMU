    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-inline" id="kriteriaDiv">
                    ...
                    <form method="POST" action="">
                        <select class="form-control mb-2 mr-sm-2" id="kriteria" name="kriteria" onChange="document.location.href=this.options[this.selectedIndex].value;">
                            ...
                            <option value="<?php echo site_url(); ?>lpmu/inputcapaian/9" disabled selected>9 - Luaran dan Capaian Tridharma</option>
                ...
                <form id="formA" name="formA" action="<?= base_url('lpmu/savecapaian9'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="idkpi[]" value="9" />
