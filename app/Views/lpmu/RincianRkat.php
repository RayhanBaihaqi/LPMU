        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Serapan Terendah Prodi <?php $nama_prodi = session('nama_prodi');
                                      echo "$nama_prodi" ?> : <br>
              Serapan Tertinggi Prodi <?php $nama_prodi = session('nama_prodi');
                                      echo "$nama_prodi" ?> : <br>
              <hr>
              rata-rata serapan prodi <?php $nama_prodi = session('nama_prodi');
                                      echo "$nama_prodi" ?> per TA <br>
              - TA 20-- : <br>
              - TA 20-- :
            </div>
            <!-- Modal footer -->
