        ...
        <div class="container col-lg-12">
            <div class="container">
                <!-- <div class="row">
                    ...
                    <div class="col-sm">
                        <br>
                        <a href="<?= base_url('lpmu/kesimpulan_tabel') ?>" class="btn btn-primary btn-block">Data Tabel</a>
                        <br>
                    </div>
                    <div class="col-sm">
                        <br>
                        <a href="<?= base_url('lpmu/grafik_rencana') ?>" class="btn btn-primary btn-block">Data Grafik Rencana</a>
                        <br>
                    </div>
                    <div class="col-sm">
                        <br>
                    ...
                    <div class="container-fluid">
                        <div class="form-group category-filter">
                            ...
                            <select class="form-control filter-satuan" id="categoryFilter">
                                ...
                                <option value="lpmu, Sarana dan Prasarana">lpmu, Sarana dan Prasarana</option>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('lpmu/form_updatecapaian/' . $row->id); ?>" class="button button2"><i class="fas fa-edit"></i></a>
                                        </td> -->
                                    <?php
                                endforeach;
                                    ?>
